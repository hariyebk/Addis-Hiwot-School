                ...
                <div className="flex flex-col lg:flex-row gap-4">
                    ...
                    <div className="bg-sky py-6 px-4 rounded-md flex-1 flex gap-4">
                        <div className="w-1/3 xl:w-1/2">
                            <Image src="/man.png" alt="teacher profile photo" width={144} height={144} className="object-cover w-36 h-36 rounded-full" />
                        </div>
                        <div className="w-2/3 flex flex-col justify-between gap-4">
                            <div className="flex items-center gap-4">
                                <h2 className="text-xl font-semibold"> Abebe kassa </h2>
                                <FormModal table="teacher" type="update" data={
                                    {
                                        id: 1,
                                        teacherId: "1234567890",
                                        username: "abebe_kassa",
                                        password: "password",
                                        firstName: "Abebe",
                                        lastName: "Kassa",
            ...
            <div className="w-full xl:w-1/3 flex flex-col gap-4">
                <div className="bg-white p-4 rounded-md"> 
                    ...
                    <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
                        <Link href={`/`} className="p-3 rounded-md bg-lightSky"> Teacher's classes </Link>
                        ...
                        <Link href={`/`} className="p-3 rounded-md bg-lightSky"> Teacher's assignments </Link>
                    </div>
                </div>
                <Performance />
                <Announcments />
